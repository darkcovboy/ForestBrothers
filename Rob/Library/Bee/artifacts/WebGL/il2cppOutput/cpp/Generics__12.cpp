...
IL_0009:
	...
	try
	{
		...
		try
		{
			BindingId_tA4E8B7CCD9EECC0531D35D35A5C6DA1ACAC40B7F L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_Add_m96F324C2A48118E5E099655A190DE856433D2485(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15))), il2cpp_rgctx_method(method->klass->rgctx_data, 21));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_009a:
	{
		...
		L_27 = KeyValuePair_2_get_Value_mE21B9B69A6B7323376C696EC224A1EF2591E51CD_inline(((L_25)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 20));
